...
function cargarTemporadas() {
  getDatos(`/series/${serieId}/temporadas/todas`)
    .then((data) => {
      ...
      const optionTop5Episodios = document.createElement("option");
      optionTop5Episodios.value = "top5episodios";
      optionTop5Episodios.textContent = "Top 5 Episodios";
      listaTemporadas.appendChild(optionTop5Episodios);
    })
    .catch((error) => {
